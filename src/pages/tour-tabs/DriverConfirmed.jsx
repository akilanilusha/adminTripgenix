...
export default function DriverConfirmed() {
  ...
  const loadDriverConfirmedTours = () => {
    setLoading(true);
    ...
    axios
      ...
      .catch((err) => {
        console.error("Failed to load driver confirmed tours", err);
      })
